...
<html>
  <head>
    ...
    <meta name="generator" content="Hovercraft! 2.0 http://regebro.github.com/hovercraft"/>
  ...
  <body class="impress-not-supported">
    <!--
        For example this progress bar and progress counter is visible on the bottom of the window.
    -->
